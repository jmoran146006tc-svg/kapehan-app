...
>
  <View className="min-w-0 flex-1 shrink items-start">
    <CardTitle numberOfLines={1} ellipsizeMode="tail" className="min-w-0 shrink">{product.name}</CardTitle>
    {product.description ? (
      <CardDescription numberOfLines={2} ellipsizeMode="tail" className="min-w-0 shrink">{product.description}</CardDescription>
    ) : null}
  </View>
