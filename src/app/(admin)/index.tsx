...
export default function AdminDashboardScreen() {
  ...
  useEffect(() => onSnapshot(collection(db, 'shops'), (snapshot) => setShops(snapshot.docs.map((item) => ({ id: item.id, ...item.data() }) as Shop)), (snapshotError) => setError(getUserFriendlyError(snapshotError, 'We could not load listings. Please try again.'))), []);
