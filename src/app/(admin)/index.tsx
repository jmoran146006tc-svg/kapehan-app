...
export default function AdminDashboardScreen() {
  ...
  useEffect(() => {
    ...
    }, (snapshotError) => setError(getUserFriendlyError(snapshotError, 'We could not load listings. Please try again.')));
  }, [role]);
